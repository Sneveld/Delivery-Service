...
var ProductsMenuModule = /** @class */ (function () {
    function ProductsMenuModule() {
    }
    ProductsMenuModule = __decorate([
        NgModule({
    ...
    return ProductsMenuModule;
}());
export { ProductsMenuModule };
//# sourceMappingURL=product.menu.module.js.map